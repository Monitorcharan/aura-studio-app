...
from controllers.paymentController import simulate_payment, get_payment_invoice, get_payment_history
from middlewares.authMiddleware import token_required

payment_bp = Blueprint('payment', __name__)

@payment_bp.route('/payments/simulate-payment', methods=['POST'])
@token_required
